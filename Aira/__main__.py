...
PM_START_TEXT = """
Hoya *{}*
My name is *{}*\n A powerful group management bot with some extras.
created by [{}](tg://user?id={})
"""


HELP_STRINGS = """
`Hola! My name is` *{}*.
[I](https://telegra.ph/file/2697c9d6ef63d9bbb5ed8.jpg) `help admins to manage their group's! Have a look at the following for an idea of some of \
the things I can help you with`.
*Main* commands available:
  🎗️- /start: for activing the bot.
  🎗️- /help: to get help.
  🎗️- /help <module name>: PM's you info about that module.(wrok in pm only)
  🎗️ - /source: for getting bot source.
  🎗️ - /settings:
...
✨You can *copy* me [here.](https://heroku.com/deploy?template=https://github.com/MR-SHRLCK/Xaira.git)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/d129b2d2d9c8df19bffc3.jpg"
else:
  img = START_IMG    
